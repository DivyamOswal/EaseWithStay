  ...
  return (
    <div className="bg-[#E6E6E6] px-6 py-4">
      <div className="max-w-[1200px] w-full mx-auto overflow-hidden">
        ...
        >
          {groupStays.map((groupStay) => (
            <SwiperSlide key={groupStay.id} className="pt-4">
              {/* Link (navigate to the hotel details page) */}
              <Link
                to={`/bungalows/${groupStay.id}`}
                state={{ source: "groupStay" }} // ✅ pass category name
              >
                  ...
                  <div className="p-3">
                    ...
                    <div className="flex text-center">
                      ...
                      <p className="text-sm mt-1 ml-2 pl-2 text-black/80">
                        Good · {groupStay.reviews} reviews
                      </p>
                    </div>
                    <div className="flex justify-between mt-2">
                      <p className="text-xs">{groupStay.nights} nights</p>
